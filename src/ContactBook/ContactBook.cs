...
public class ContactBook
{
    ...
    private void UpdateContact(int index)
    {
        ...
        if(Confirm("Do you want to update this contact?", NO))
        {
            ...
            c.SetPhone(phone);
            c.SetEmail(email);
            Console.WriteLine("Operation succseful: Contact updated.");
        }
        else
        {
     ...
     private void DeleteContact()
    {
       ...
       private void DeleteContact(int index)
       {
        ...
        if(Confirm("Do you want to delete this contact?", NO))
        {
            ...
            Console.WriteLine("Operation succseful: Contact deleted.");
        }
        else
        {
    ...
    private void FindContacts()
    {
        ...
        if(Confirm("Do you want to search contacts?", YES))
        {
            ...
            page = 1;            
            Console.WriteLine("Operation succseful: Contacts searched.");
        }
        else
        {
    ...
    private void DeduplicateContacts()
    {
        ...
        foreach(var group in duplicateGroups)
        {
            if(group.Count > 1)
            {
              ...
              if(Confirm("Do you want to merge these contacts?", NO))
                {
                    temp.Add(merged);
                    Console.WriteLine("Operation successful: Contact merged.");
                }
                else
                {
                    temp.AddRange(group);
                    Console.WriteLine("Operation cancelled: Contact not merged.");
                }
        ...
        if(Confirm("Do you want to apply all merges to the contact list?", NO))
        {
            ...
            Console.WriteLine("Operation succesful: Contacts deduplicated.");
        }
        else
        {
